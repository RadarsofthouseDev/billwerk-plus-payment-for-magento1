 ...
 *
 */
class Radarsofthouse_Reepay_Model_Resurs extends Radarsofthouse_Reepay_Model_Standard
{
    protected $_code = 'reepay_resurs';

    protected $_formBlockType = 'reepay/form_resurs';
    protected $_infoBlockType = 'reepay/info_resurs';
