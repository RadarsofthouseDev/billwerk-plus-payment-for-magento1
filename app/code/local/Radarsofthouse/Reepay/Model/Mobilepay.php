 ...
 *
 */
class Radarsofthouse_Reepay_Model_Mobilepay extends Radarsofthouse_Reepay_Model_Standard
{
    protected $_code = 'reepay_mobilepay';

    protected $_formBlockType = 'reepay/form_mobilepay';
    protected $_infoBlockType = 'reepay/info_mobilepay';
