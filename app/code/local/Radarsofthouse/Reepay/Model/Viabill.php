 ...
 *
 */
class Radarsofthouse_Reepay_Model_Viabill extends Radarsofthouse_Reepay_Model_Standard
{
    protected $_code = 'reepay_viabill';

    protected $_formBlockType = 'reepay/form_viabill';
    protected $_infoBlockType = 'reepay/info_viabill';
