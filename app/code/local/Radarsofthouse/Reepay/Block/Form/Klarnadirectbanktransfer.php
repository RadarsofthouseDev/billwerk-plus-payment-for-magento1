 ...
 *
 */
class Radarsofthouse_Reepay_Block_Form_Klarnadirectbanktransfer extends Mage_Payment_Block_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('reepay/form/klarnadirectbanktransfer.phtml');
    }
